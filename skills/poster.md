...
Read .agents/design-context.md for brand colors, fonts, style archetype
If missing, ask user to run design-context skill or proceed with defaults
Posters often have more creative freedom than other formats -- but brand colors and fonts should still anchor the design
